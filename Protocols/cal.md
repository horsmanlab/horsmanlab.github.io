...
Change to low-flow needle and remove sweep cone.

-	IT < 1 (no more than 2)
-	NL should be ~5 x 10^6 for centroid (about 1/10th for profile) (it’s the largest peak, e.g. caffeine)
-	Tube lens - increase to get bigger ions transmitted (e.g. increase from 50-100 V will see higher large m/z peaks)
-	90 V tube lens will give your 1400-1500 peaks ~40% of caffeine
-	262 and 524 are MRFA (262 is +2 charged so 0.5 isotopic separataion)
-	Note: centroid will giber higher NL than profile
-	Can press average button to make spectra more stable
-	Can increase spray voltage from 3 to 3.5 and helps
-	ST (scan time) ~0.47 for 150-2000; 0.16 for 150-600
-	Use ‘normal’ not ‘enhanced’
-	Ultrazoom useful for distinguishing molecules with similar m/z (28 mass unit per second)
